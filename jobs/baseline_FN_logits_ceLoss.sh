...
#SBATCH --job-name=baseline_FN_logits_celoss
...
wait
python finetune.py --save_dir ./logs/baseline_FN_logits_celoss --target_dataset ChestX --subset_split datasets/split_seed_1/ChestX_labeled_80.csv --embedding_load_path ./logs/baseline_FN_logits_celoss/checkpoint_best.pkl --freeze_backbone
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/FeatureNorm/logs/baseline_FN_logits_celoss/ ~/scratch/FeatureNorm/logs/
