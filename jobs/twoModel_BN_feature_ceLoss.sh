...
python twoModel_BN_feature_ceLoss.py --dir ./logs/twoModel_BN_feature_ceLoss --bsize 128 --epochs 1000 --model resnet10
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/FeatureNorm/logs/twoModel_BN_feature_ceLoss/ ~/scratch/FeatureNorm/logs/
