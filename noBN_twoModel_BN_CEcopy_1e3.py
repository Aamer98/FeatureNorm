...
def train(model, model_noBN, clf, clf_noBN,
    ...
    for i, (X_base, y_base) in enumerate(base_trainloader):
        ...
        loss_base = loss_ce(logits_base, logits_base_noBN.detach())
        #loss_diff = mse_criterion(logits_base, logits_base_noBN.detach())
        loss = loss_base #+ loss_diff
