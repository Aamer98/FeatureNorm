...
python finetune.py --save_dir ./logs/baseline_nb/ISIC --target_dataset ISIC --subset_split datasets/split_seed_1/ISIC_labeled_80.csv --embedding_load_path ./logs/baseline_nb/checkpoint_best.pkl --freeze_backbone &
wait
python finetune.py --save_dir ./logs/baseline_nb/ChestX --target_dataset ChestX --subset_split datasets/split_seed_1/ChestX_labeled_80.csv --embedding_load_path ./logs/baseline_nb/checkpoint_best.pkl --freeze_backbone
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/BMS/logs/baseline_nb/ ~/scratch/BMS/logs/